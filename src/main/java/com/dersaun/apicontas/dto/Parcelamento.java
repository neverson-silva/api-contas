...
import static com.dersaun.apicontas.util.NumberUtil.roundValue;
...
public class Parcelamento implements Serializable {
    ...
    public Parcelamento(Lancamento lancamento, Mes mes) {
        ...
        this.mesAno = MesUtil.getMesAnoReferencia(lancamento.getMes().getId(), lancamento.getAno(), true);
    }
    ...
    public Parcelamento(Lancamento lancamento, Mes mes, Integer numeroInicial, Boolean isAtual,
        ...
        this.atual = isAtual;
        this.quantidade = quantidade;
        this.mesAno = MesUtil.getMesAnoReferencia(mesId, ano, true);
    ...
    public MesAnoDTO getMesAno() {
        if (mesAno == null) {
            return MesUtil.getMesAnoReferencia(mesAtual, true);
        }
        return mesAno;
    }
