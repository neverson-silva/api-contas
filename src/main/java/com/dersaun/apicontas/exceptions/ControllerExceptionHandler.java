...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<?> standardError(StandardHttpException e, HttpServletRequest request) {
    ...
    private Map<String, Object> prepareErrorMap(StandardHttpException ex) {
