...
@NoArgsConstructor
@AllArgsConstructor
@ToString(exclude = {"lancamentoRelacionado", "lancamentos"})
...
public class Lancamento implements Divisivel, Serializable {
    ...
    public BigDecimal getValorPorParcela() {
        ...
        return NumberUtil.roundValue(valor);
    }
    ...
    public void setValor(BigDecimal valor) {
        if (valor != null) {
            this.valor = NumberUtil.roundValue(valor);
        } else {
            this.valor = null;
        }
    }
    ...
    public void setValorDividido(BigDecimal valor) {
        if (valor != null) {
            this.valorDividido = NumberUtil.roundValue(valor);
        } else {
